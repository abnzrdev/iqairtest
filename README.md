# Breez - Air Quality Monitoring Application
...
- `DATABASE_NAME` - имя базы данных (по умолчанию: breez)
- `SECRET_KEY` - секретный ключ для JWT
- `BREEZ_API_KEY` - API ключ (опционально, можно использовать mock данные)
